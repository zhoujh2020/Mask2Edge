...
class MixVisionTransformer(nn.Module):
    def __init__(self, in_chans=3, num_classes=1000, embed_dims=(32, 64, 160, 256, 512),
                 ...
                 depths=(3, 4, 6, 3, 2), sr_ratios=(16, 8, 4, 2, 1)):
        super().__init__()
...
class EnMiTB5(MixVisionTransformer):
    def __init__(self):
        super(EnMiTB5, self).__init__(
            embed_dims=[64, 128, 320, 512, 768], num_heads=[1, 2, 5, 8, 8], mlp_ratios=[4, 4, 4, 4, 4],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[3, 4, 6, 3, 2], sr_ratios=[8, 4, 2, 1, 1],
