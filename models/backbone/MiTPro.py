...
class MiTB0(MixVisionTransformer):
    def __init__(self, pretrained=False):
        ...
        if pretrained:
            ...
            self.load_state_dict(torch.load("./mit_pretrained/mit_b0.pth"), strict=False)
...
class MiTB1(MixVisionTransformer):
    def __init__(self, pretrained=False):
        ...
        if pretrained:
            print("Load backbone weights")
            self.load_state_dict(torch.load("./mit_pretrained/mit_b1.pth"), strict=False)
...
class MiTB2(MixVisionTransformer):
    def __init__(self, pretrained=False):
        ...
        if pretrained:
            print("Load backbone weights")
            self.load_state_dict(torch.load("./mit_pretrained/mit_b2.pth"), strict=False)
...
class MiTB3(MixVisionTransformer):
    def __init__(self, pretrained=False):
        ...
        if pretrained:
            print("Load backbone weights")
            self.load_state_dict(torch.load("./mit_pretrained/mit_b3.pth"), strict=False)
...
class MiTB4(MixVisionTransformer):
    def __init__(self, pretrained=False):
        ...
        if pretrained:
            print("Load backbone weights")
            self.load_state_dict(torch.load("./mit_pretrained/mit_b4.pth"), strict=False)
...
class MiTB5(MixVisionTransformer):
    def __init__(self, pretrained=False):
        ...
        if pretrained:
            print("Load backbone weights")
            self.load_state_dict(torch.load("./mit_pretrained/mit_b5.pth"), strict=False)


class MiTPro(MixVisionTransformer):
    def __init__(self, pretrained=False):
        super(MiTPro, self).__init__(
            embed_dims=[32, 64, 160, 256], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[2, 2, 6, 2], sr_ratios=[8, 4, 2, 1],
            drop_rate=0.0, drop_path_rate=0.1)
